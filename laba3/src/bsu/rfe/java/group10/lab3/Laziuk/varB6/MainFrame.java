...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action seeMoreAboutAuthor = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Автор: Лозюк А.Д., гр. 10", "Об авторе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
        // Добавить соответствующий пункт подменю в меню "Файл"
        saveToTextMenuItem = infoMenu.add(seeMoreAboutAuthor);
        ...
        // Создать новое действие по поиску значений многочлена - Таблица
        ...
        // По умолчанию пункт меню является недоступным (данных ещѐ нет)
        searchValueMenuItem.setEnabled(false);  // значение по умолчпние в поиске таблицы = null
    ...
    protected void saveToTextFile(File selectedFile) {  // cохранение в текстовый файл
        try {
    ...
    public static void main(String[] args) {
        ...
        // Если преобразование невозможно - сообщить об ошибке и завершиться
            System.out.println("Error parse str '" +
            args[i] + "' in double");
            System.exit(-2);
        }
